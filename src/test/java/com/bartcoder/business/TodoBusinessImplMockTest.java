...
//	private TodoService todoServiceMock = mock(TodoService.class);
	...
	/**
	@Test
	public void testRetriveListSizeTodos_usingMock2() {
		assertEquals(2, filteredTodos.size());
	}
	
	@Test
	public void testRetriveTodosObjectRelatedToSpring_usingMock() {
	...
	public void testUserAthorization() {
		assertEquals(true, todoBusinessImpl.haveUserAuthorization("Tommy"));
	}
	**/
